...
techs$comp3 <- cut(techs$sleep_baseline, 
                       ...
                       labels=c("3","2","1", "0"))
techs$waketime_baseline <- as.numeric(techs$waketime_baseline)
techs$bedtime_baseline <- as.numeric(techs$bedtime_baseline)

techs$actual_sleep <- techs$waketime_baseline - techs$bedtime_baseline
